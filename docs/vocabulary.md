...
- flow: a named specification of steps and their dependencies.
- step: the minimal unit of execution within a flow.
- execution: a single run of a flow against declared inputs.
